...
<head>
    ...
    <title>Leads (Orfao's Autoparts)</title>
...
<font size="5">Leads ( Orfao's Autoparts )</font>
  ...
  <table width="80%" align="center">
    ...
    <table align="center">
      <tr>
        <td>
          <input type="Submit" name="First" value="First" style="height:40px; width:120px; font-size:20px;"> &nbsp;

          <input type="Submit" name="Next" value="Next" style="height:40px; width:120px; font-size:20px;"> &nbsp;

          <input type="Submit" name="Prev" value="Prev" style="height:40px; width:120px; font-size:20px;"> &nbsp;

          <input type="Submit" name="Last" value="Last" style="height:40px; width:120px; font-size:20px;"> &nbsp;
