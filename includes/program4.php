...
<style>
	...
	<head>
		...
		<title>Orfao Richard Program 4</title>
  ...
  <body link="blue" vlink="blue" alink="red" onload="currentTime()">
    ...
    <font size="5">Orfao Richard Program 4</font>
      ...
      <table width="80%" align="center">
        ...
        <tr>
          ...
          <td style="width: 20%;">
            ...
            <textarea name="Comments" placeholder="Comments" style="width: 80%; height: 100; font-size: 28px;"><?php echo $Comments;?></textarea>
      ...
      <table align="center" >
        ...
        <tr>
          <td align="center">
            ...
            <input type="Submit" name="Help" value="Help" style="height:40px; width:120px; font-size:20px;"> &nbsp;
